        ...
        <div class="row">
            <div class="col">
                <div class="breadcrumb-contain">
                    <div>
                        <h2>Delivery Boy Checkin</h2>
                        <ul>
                            <li><h4>WELCOME BACK ... !</h4></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-8 offset-xl-4 offset-lg-3 offset-md-2">
                <div class="theme-card" style="border-style:solid; border-width:5px; border-color:#d3d3d3; background-color:white;">
                    <h3 class="text-center">Boy Name</h3>
                        ...
                        <br>
                        <p class="text-center" style="font-size:30px;">My Orders</p>
                        <h5 class="text-center">Number</h5>
                        <p class="text-center" style="font-size:30px">Order Success</p>
                        <h5 class="text-center">Number</h5>
                        <p class="text-center" style="font-size:30px">Ratings</p>
                        <h5 class="text-center">Number</h5>
